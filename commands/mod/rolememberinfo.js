...
module.exports = {
  config: {
    ...
    aliases: ["rmi", "rmemberinfo", "roleinfo"],
  },
  run: async (client, message, args) => {
    ...
    let roleEmbed = new MessageEmbed().setColor("#2F3136").setThumbnail(message.guild.iconURL()).setTitle(`Users With The ${role.name} Role!`).setDescription(membersWithRole.join("\n"));
